    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <!--li><button href="#" class="danger btn btn-primary" style="transform: translateY(7px);">Sign in/ Sign up</button></li-->
      ...
      <div class="home__header-content">
        <div id="main-home-carousel" class="owl-carousel">
          <div>
            ...
            <a class="btn btn-custom" href="/create">Get started</a>
          ...
          <div>
            ...
            <a class="btn btn-custom" href="/create">See more</a>
          </div><!--slide item like paragraph-->
